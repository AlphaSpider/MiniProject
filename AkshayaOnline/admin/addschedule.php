            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="active">
                            <a href="addschedule.php"><i class="fa fa-fw fa-table"></i> Service Schedule</a>
                        </li>
                        <li>
                            <a href="patientlist.php"><i class="fa fa-fw fa-edit"></i> User List</a>
                        </li>
                        <li>
                            <a href="updatetoken.php"><i class="fa fa-fw fa-edit"></i> Update Token</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                                ...
                                <div class="form-group form-group-lg">
                                  ...
                                  <div class="col-sm-10">
                                   <select class="select form-control" id="service" name="service" required>
                                    <option value="Aadhaar Enrollment">
                                    Aadhaar Enrollment
                                    </option>
                                    <option value="Ration Card Services">
                                    Ration Card Services
                                    </option>
                                    <option value="Community Certificate">
                                    Community Certificate
                                    </option>
                                    <option value="Dependency certificate">
                                    Dependency certificate
                                    </option>
                                    <option value="Pancard Servicesn">
                                    Pancard Services
                                    </option>
                                    <option value="Aadhaar Updation">
                                    Aadhaar Updation
                                    </option>
                                   </select>
                                  </div>
