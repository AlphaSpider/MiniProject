...
<html lang="en">
	...
	<body>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<ul class="nav navbar-nav">
							...
							<li><a href="patientapplist.php?patientId=<?php echo $userRow['icPatient']; ?>">Reservation</a></li>
						</ul>
					</ul>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li>
									<a href="patientapplist.php?patientId=<?php echo $userRow['icPatient']; ?>"><i class="glyphicon glyphicon-file"></i> Reservation</a>
								</li>
								<li class="divider"></li>
								<li>
				...
				<div class="row">
					<div class="col-xs-12 col-md-8">
						...
						echo "<div class='row'>";
							...
							?>
							<!-- notification end -->
							<h2>Hi <?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?>. Reserve Token Now!</h2>
		...
		<div class="copyright-bar bg-black">
			<div class="container">
				<p class="pull-left small">©akshayatokenreservation</p>
