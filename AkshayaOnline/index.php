...
<html lang="en">
    <head>
        ...
        <title>Akshaya Token Booking System</title>
        <!-- Bootstrap -->
    ...
    <body>
        ...
        <section id="promo-1" class="content-block promo-1 min-height-600px bg-offwhite">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <?php
                          $query = 'select t_number from token where t_id=1';
                          $resultToken = mysqli_query($con, $query);

                          if ($resultToken && mysqli_num_rows($resultToken) > 0) {
                            $rowToken = mysqli_fetch_assoc($resultToken);
                            $currentTokenNumber = $rowToken['t_number'];
                        } else {
                            $currentTokenNumber = "N/A"; // Set a default value if no token is found
                        }
                        ?>
                        <h1>Current Token no:<?php echo $currentTokenNumber?></h1>
                        <h2>Reserve Token today!</h2>
                        <p>Please <span class="label label-danger">login</span> to reserve token. </p>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                <div class="underlined-title">
                    <h1>Our Services</h1>
                    <hr>
                    <h2>Look the services that we provide.</h2>
                </div>
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                            <a><img alt="aadhaar" src="assets/img/aadhaar.png" height="40px"></a>
                        </div>
                        <div class="col-xs-10">

                            
                            <h4>Aadhaar Enrollment</h4>
                            <p>A 12-digit unique number issued for all residents in India by the Unique Identification Authority of India (UIDAI)</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                            <a><img alt="ration" src="assets/img/rationcard.png" height="32px"></a>
                        </div>
                        <div class="col-xs-10">
                            <h4>Ration Card Services</h4>
                            <p>The service enables to submit online, applications related to ration cards.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                            <a><img alt="com" src="assets/img/com.png" height="40px"></a>
                        </div>
                        <div class="col-xs-10">
                            <h4>Community Certificate</h4>
                            <p>You can apply for a community certificate online.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                            <a><img alt="dep" src="assets/img/dep.png" height="40px"></a>
                        </div>
                        <div class="col-xs-10">
                            <h4>Dependency certificate</h4>
                            <p>Dependency certificate is a certificate that shows that one is a dependent of someone else with whom he/she has a relation.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                            <a><img alt="pan" src="assets/img/pan.png" height="40px"></a>
                        </div>
                        <div class="col-xs-10">
                            <h4>Pancard Services</h4>
                            <p>Applying for, issuing, or reissuing a PAN card.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                            <a><img alt="aadhaar" src="assets/img/aadhaar2.png" height="36px"></a>
                        </div>
                        <div class="col-xs-10">
                            <h4>Aadhaar Updation</h4>
                            <p> Update the Demographic and Biometric details of a resident.</p>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">©akshayaonline </p>
