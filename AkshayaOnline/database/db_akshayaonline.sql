...
CREATE TABLE `token` (
  ...
  `t_number` int(11) NULL,
  
)ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table

INSERT INTO `token` (`t_id`, `t_number`) VALUES
(1, 10);
...
INSERT INTO `doctorschedule` (`service`, `scheduleId`, `scheduleDate`, `scheduleDay`, `startTime`, `endTime`, `bookAvail`) VALUES
(40,'Aadhaar Enrollment', '2015-12-13', 'Sunday', '09:00:00', '10:00:00', 'notavail'),
(41,'Aadhaar Enrollment', '2015-12-13', 'Sunday', '10:00:00', '11:00:00', 'available'),
(42,'Aadhaar Enrollment', '2015-12-13', 'Sunday', '11:00:00', '12:00:00', 'available'),
(43,'Aadhaar Enrollment', '2015-12-14', 'Monday', '11:00:00', '12:00:00', 'available'),
(44,'Aadhaar Enrollment', '2015-12-13', 'Sunday', '01:00:00', '02:00:00', 'available');
